...
issue](https://github.com/cisagov/cool-dns-dmarc-import/issues) in this
...
request](https://github.com/cisagov/cool-dns-dmarc-import/pulls), you
...
```console
cd cool-dns-dmarc-import
pyenv virtualenv <python_version_to_use> cool-dns-dmarc-import
pyenv local cool-dns-dmarc-import
